...
export const wrong_category = (data) => {
    if (data.competition && data.competition.category && data.competition.category.value) {
        // mark the incorrect-category error only for competition events and for athletes
