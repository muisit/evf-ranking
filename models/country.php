 ...
 */
 ...
 class Country extends Base {
    ...
    // "country_rep_firstname","country_rep_surname","country_rep_email","country_rep_telnum","country_rep_mob","country_flag_path","country_web");
    public $fieldToExport=array(
        "country_id" => "id",
        "country_abbr" => "abbr",
        "country_name" => "name",
//          "country_rep_firstname" => "rep_firstname",
//          "country_rep_surname" => "rep_surname",
//          "country_rep_email" => "email",
//          "country_web" => "web",
//          "country_rep_telnum" => "tel",
//          "country_rep_mob" => "mob",
