...
class Migration0004 extends MigrationObject
{
    public function __construct($id = null, $forceload = false)
    {
        ...
        $this->name = "004: More adjustments to TD_Result";
    }

    public function up()
    {
        $this->rawQuery("ALTER TABLE `TD_Result` DROP `result_weapon`;");
        $this->rawQuery("ALTER TABLE `TD_Result` DROP `result_category`;");
    }
