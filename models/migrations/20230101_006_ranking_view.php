...
class Migration0006 extends MigrationObject
{
    public function __construct($id = null, $forceload = false)
    {
        parent::__construct($id, $forceload);
        $this->name = "006: Add Ranking View";
    }

    public function up()
    {
        $this->rawQuery("ALTER TABLE `TD_Result` ADD COLUMN result_in_ranking enum('Y', 'N') DEFAULT('N');");
